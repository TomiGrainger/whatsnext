...
2. Open the room. Every crew page without a `?room=` follows the newest open
   room, so you can bookmark them bare. Note the code — and check it is the one marked **TONIGHT**
